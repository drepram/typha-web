    ...
    <div class="container mx-auto">
      <div class="mx-auto w-full md:w-1/2 py-8 px-4">
        ...
        <div class="flex items-center mb-6">
          <h1 class="tracking-wide text-white mr-6"><span v-on:click="deleteAll()">Tasks</span> You've Done</h1><br><br>
          <h3 class="text-white mr-6">on {{ new Date() | moment("MMMM Do YYYY") }}</h3>

          <img src="/src/assets/icon.png" class="hidden md:block" width="40" alt="">
        </div>
          ...
          <transition-group name="fade">
            <li v-for="todo in todos" :key="todo.id"
              ...
              <div>
                ...
                <label :for="todo.id" class="cbx__lbl text-white inline-block mt-1" :class="{ completed: todo.completed }">Completed {{ todo.title }} on <span class="subtitle-text">{{ todo.time }}</span></label>
              </div>
